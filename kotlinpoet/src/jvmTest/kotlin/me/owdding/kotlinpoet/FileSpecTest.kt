...
import me.owdding.kotlinpoet.AnnotationSpec.UseSiteTarget.SET
import me.owdding.kotlinpoet.KModifier.VARARG
...
class FileSpecTest {
  ...
  @Test fun importStaticMixed() {
    val source = FileSpec.builder("me.owdding.tacos", "Taco")
      .addType(
  ...
  @Test fun importTopLevel() {
    val source = FileSpec.builder("me.owdding.tacos", "Taco")
      .addImport("me.owdding.tacos.internal", "INGREDIENTS", "wrap")
      .addFunction(
        FunSpec.builder("prepareTacos")
          .returns(
            List::class.asClassName()
              .parameterizedBy(ClassName("me.owdding.tacos", "Taco")),
          )
    ...
    assertThat(source.toString()).isEqualTo(
      """
        |package me.owdding.tacos
        |
        |import me.owdding.tacos.`internal`.INGREDIENTS
        |import me.owdding.tacos.`internal`.wrap
        |import kotlin.collections.List
        |
  ...
  @Test fun singleImportEscapeKeywords() {
    val source = FileSpec.builder("me.owdding.tacos", "Taco")
      .addType(
        TypeSpec.classBuilder("Taco")
          .addProperty("madeFreshDate", ClassName("me.owdding.is.fun.in", "Date"))
          .build(),
      )
      .build()
    assertThat(source.toString()).isEqualTo(
      """
        |package me.owdding.tacos
        |
        |import me.owdding.`is`.`fun`.`in`.Date
        |
        |public class Taco {
        |  public val madeFreshDate: Date
        |}
  ...
  @Test fun escapeSpacesInPackageName() {
    val file = FileSpec.builder("me.owdding.taco factory", "TacoFactory")
      .build()
    assertThat(file.toString()).isEqualTo(
      """
      |package me.owdding.`taco factory`
      |
      |
      """.trimMargin(),
    )
  ...
  @Test fun conflictingImportsEscapedWithoutBackticks() {
    ...
    val testFile = FileSpec.builder("me.owdding.kotlinpoet.test", "TestFile")
      .addFunction(testFun)
      .build()
    ...
    assertThat(testFile.toString())
      .isEqualTo(
        """
          |package me.owdding.kotlinpoet.test
          |
  ...
  @Test fun conflictingImportsEscapeKeywords() {
    val source = FileSpec.builder("me.owdding.tacos", "Taco")
      .addType(
        TypeSpec.classBuilder("Taco")
          .addProperty("madeFreshDate1", ClassName("me.owdding.is.fun.in", "Date"))
          .addProperty("madeFreshDate2", ClassName("me.owdding.do.val.var", "Date"))
          .build(),
      )
      .build()
    assertThat(source.toString()).isEqualTo(
      """
        |package me.owdding.tacos
        |
        |import me.owdding.`do`.`val`.`var`.Date as VarDate
        |import me.owdding.`is`.`fun`.`in`.Date as InDate
        |
        |public class Taco {
  ...
  @Test fun escapeSpacesInImports() {
    val tacoFactory = ClassName("me.owdding.taco factory", "TacoFactory")
    ...
    assertThat(file.toString()).isEqualTo(
      ...
      |package com.example
      |
      |import me.owdding.`taco factory`.TacoFactory
      |
      |public fun main() {
  ...
  @Test fun escapeSpacesInAliasedImports() {
    ...
    assertThat(file.toString()).isEqualTo(
      ...
      |package com.example
      |
      |import me.owdding.`taco factory`.TacoFactory as `La Taqueria`
      |
      |public fun main() {
  ...
  @Test fun conflictingParentName() {
    val source = FileSpec.builder("me.owdding.tacos", "A")
      .addType(
            ...
            TypeSpec.classBuilder("B")
              ...
              .addType(
                TypeSpec.classBuilder("C")
                  .addProperty("d", ClassName("me.owdding.tacos", "A", "Twin", "D"))
                  .build(),
              )
              .build(),
          )
  ...
  @Test fun nestedClassAndSuperclassShareName() {
    val source = FileSpec.builder("me.owdding.tacos", "Taco")
      .addType(
        TypeSpec.classBuilder("Taco")
          .superclass(ClassName("me.owdding.wire", "Message"))
          .addType(
            TypeSpec.classBuilder("Builder")
              .superclass(ClassName("me.owdding.wire", "Message", "Builder"))
              .build(),
          )
          .build(),
      )
    ...
    assertThat(source.toString()).isEqualTo(
      """
        |package me.owdding.tacos
        |
        |import me.owdding.wire.Message
        |
  ...
  @Test fun annotationIsNestedClass() {
    val source = FileSpec.builder("me.owdding.tacos", "TestComponent")
      .addType(
  ...
  @Test fun packageClassConflictsWithNestedClass() {
    val source = FileSpec.builder("me.owdding.tacos", "Taco")
      .addType(
        TypeSpec.classBuilder("Taco")
          .addProperty("a", ClassName("me.owdding.tacos", "A"))
    ...
    assertThat(source.toString()).isEqualTo(
      """
        ...
        |
        |public class Taco {
        |  public val a: me.owdding.tacos.A
        |
        |  public class A
        |}
        |
  ...
  @Test fun multipleTypesInOneFile() {
    val source = FileSpec.builder("me.owdding.tacos", "AB")
      .addType(TypeSpec.classBuilder("A").build())
  ...
  @Test fun fileAnnotationMustHaveCorrectUseSiteTarget() {
    val builder = FileSpec.builder("me.owdding.tacos", "Taco")
  ...
  @Test fun escapeKeywordInPackageName() {
    val source = FileSpec.builder("me.owdding.is.fun.in", "California")
      .build()
    assertThat(source.toString()).isEqualTo(
      """
        |package me.owdding.`is`.`fun`.`in`
        |
        |
      """.trimMargin(),
    )
  ...
  @Test fun generalBuilderEqualityTest() {
    val source = FileSpec.builder("me.owdding.tacos", "Taco")
      ...
      .addImport("me.owdding.tacos.internal", "INGREDIENTS")
      .addTypeAlias(TypeAliasSpec.builder("Int8", Byte::class).build())
      .indent("  ")
      .addFunction(
  ...
  @Test fun longFilePackageName() {
    val spec = FileSpec.builder("me.owdding.taco.enchilada.quesadillas.tamales.burritos.super.burritos.trying.to.get.a.really.large.packagename", "Test")
      .addFunction(
        FunSpec.builder("foo")
          .build(),
      )
    ...
    assertThat(spec.toString()).isEqualTo(
      """
      |package me.owdding.taco.enchilada.quesadillas.tamales.burritos.`super`.burritos.trying.to.`get`.a.really.large.packagename
      |
      |public fun foo() {
      |}
      |
  ...
  @Test fun longComment() {
    val file = FileSpec.builder("me.owdding.tacos", "Taco")
      .addFileComment(
  ...
  @Test fun longCommentWithTypes() {
    ...
    assertThat(file.toString()).isEqualTo(
      ...
      |package me.owdding.tacos
      |
      |import me.owdding.kotlinpoet.FileSpecTest
      |import kotlin.String
