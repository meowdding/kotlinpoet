...
class PropertySpecTest {
  ...
  @Test fun generalBuilderEqualityTest() {
    ...
    val prop = PropertySpec.builder("tacos", Int::class)
      .mutable()
      .addAnnotation(ClassName("me.owdding.kotlinpoet", "Vegan"))
  ...
  @Test fun annotatedLambdaType() {
    val annotation = AnnotationSpec.builder(ClassName("me.owdding.tacos", "Annotation")).build()
    val type = LambdaTypeName.get(returnType = UNIT).copy(annotations = listOf(annotation))
    val spec = FileSpec.builder("me.owdding.tacos", "Taco")
  ...
  fun annotatedValWithContextReceiver() {
    ...
    assertThat(propertySpec.toString()).isEqualTo(
      """
      |context(kotlin.String)
      |@me.owdding.kotlinpoet.PropertySpecTest.TestAnnotation
      |val foo: kotlin.Int
      |  get() = length
      |
      """.trimMargin(),
  ...
  @Test fun valWithAnnotatedContextParameter() {
    ...
    assertThat(propertySpec.toString()).isEqualTo(
      """
      |context(str: @me.owdding.kotlinpoet.PropertySpecTest.TestAnnotation kotlin.String)
      |val foo: kotlin.Int
      |  get() = str.length
      |
      """.trimMargin(),
