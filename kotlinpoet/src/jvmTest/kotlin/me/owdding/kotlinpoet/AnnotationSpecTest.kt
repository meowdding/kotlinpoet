...
import me.owdding.kotlinpoet.ParameterizedTypeName.Companion.plusParameter
...
class AnnotationSpecTest {
  ...
  @Test fun defaultAnnotation() {
    ...
    assertThat(toString(annotation)).isEqualTo(
      """
        ...
        |
        |import me.owdding.kotlinpoet.AnnotationSpecTest
  ...
  @Test fun defaultAnnotationWithImport() {
    ...
    val file = FileSpec.get("me.owdding.kotlinpoet", typeBuilder.build())
  ...
  @Test fun emptyArray() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
      "" +
        "@me.owdding.kotlinpoet.AnnotationSpecTest.HasDefaultsAnnotation(" +
        "n = []" +
        ")",
    )
  ...
  @Test fun useSiteTarget() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
      "" +
        "@me.owdding.kotlinpoet.AnnotationSpecTest.AnnotationA",
    )
    builder.useSiteTarget(AnnotationSpec.UseSiteTarget.FIELD)
    assertThat(builder.build().toString()).isEqualTo(
      "" +
        "@field:me.owdding.kotlinpoet.AnnotationSpecTest.AnnotationA",
    )
    builder.useSiteTarget(AnnotationSpec.UseSiteTarget.GET)
    assertThat(builder.build().toString()).isEqualTo(
      "" +
        "@get:me.owdding.kotlinpoet.AnnotationSpecTest.AnnotationA",
    )
  ...
  @Test fun annotationsWithTypeParameters() {
    ...
    val externalClass = ClassName("me.owdding.parceler", "ExternalClass")
    val externalClassSpec = TypeSpec.classBuilder(externalClass)
      ...
      .build()
    val externalClassParceler = ClassName("me.owdding.parceler", "ExternalClassParceler")
    val parcel = ClassName("me.owdding.parceler", "Parcel")
    val externalClassParcelerSpec = TypeSpec.objectBuilder(externalClassParceler)
      .addSuperinterface(
        ClassName("me.owdding.parceler", "Parceler")
      ...
      .build()
    val parcelize = ClassName("me.owdding.parceler", "Parcelize")
    val typeParceler = ClassName("me.owdding.parceler", "TypeParceler")
    ...
    val propertyLocalParceler = TypeSpec.classBuilder("MyClass")
      ...
      .build()
    val writeWith = ClassName("me.owdding.parceler", "WriteWith")
    ...
    val typeLocalParceler = TypeSpec.classBuilder("MyClass")
      ...
      .build()
    val file = FileSpec.builder("me.owdding.parceler", "Test")
  ...
  private fun toString(typeSpec: TypeSpec) =
    FileSpec.get("me.owdding.tacos", typeSpec).toString()
}
