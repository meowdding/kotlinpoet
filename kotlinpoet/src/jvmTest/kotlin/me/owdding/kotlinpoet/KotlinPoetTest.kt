...
import me.owdding.kotlinpoet.jvm.jvmField
import me.owdding.kotlinpoet.jvm.jvmSuppressWildcards
...
class KotlinPoetTest {
  ...
  @Test fun foldingPropertyWithEscapedName() {
    val file = FileSpec.builder("me.owdding.tacos", "AlarmInfo")
      .addType(
  ...
  @Test fun noWrappingBetweenValAndPropertyName() {
    val wireField = ClassName("me.owdding.wire", "WireField")
    val file = FileSpec.builder("me.owdding.tacos", "Taco")
      .addType(
        TypeSpec.classBuilder("Taco")
    ...
    assertThat(file.toString()).isEqualTo(
      ...
      |package me.owdding.tacos
      |
      |import me.owdding.wire.WireField
      |import kotlin.String
      |
        ...
        TypeSpec.classBuilder("Builder")
          ...
          .addFunction(
            FunSpec.builder("summary_text")
              ...
              .returns(ClassName("me.owdding.tacos", "Builder"))
  ...
  @Test fun typeNamesInsideTemplateStringsGetImported() {
    ...
    val file = FileSpec.builder("me.owdding.example", "Tacos")
      .addFunction(
  ...
  @Test fun allStringsAreUnderscore() {
    val file = FileSpec.builder("me.owdding.tacos", "SourceWithUnderscores")
      .addType(
  ...
  @Test fun generatedImportAliases() {
    val squareTaco = ClassName("me.owdding.tacos", "Taco")
    val blockTaco = ClassName("xyz.block.tacos", "Taco")
    val kotlinIsNullOrEmpty = MemberName("kotlin.text", "isNullOrEmpty")
    val cashIsNullOrEmpty = MemberName("me.owdding.cash.util", "isNullOrEmpty")
    ...
    assertThat(file.toString()).isEqualTo(
      ...
      |package com.example
      |
      |import me.owdding.cash.util.isNullOrEmpty as utilIsNullOrEmpty
      |import me.owdding.tacos.Taco as SquareupTacosTaco
  ...
  @Test fun memberImportsOverGeneratedImportAliases() {
    ...
    assertThat(file.toString()).isEqualTo(
      ...
      |package com.example
      |
      |import me.owdding.cash.util.isNullOrEmpty as cashIsNullOrEmpty
      |import me.owdding.tacos.Taco as SquareTaco
  ...
  @Test fun importAliasCollisionWithRegularImportWhenAliasesComputedFirst() {
    val class1 = ClassName("me.owdding.taco", "Meal")
    val class2 = ClassName("me.owdding.burrito", "Meal")
    val class3 = ClassName("me.owdding.meal", "TacoMeal")
    ...
    assertThat(source.toString()).isEqualTo(
      """
        ...
        |
        |import me.owdding.meal.TacoMeal
        |import me.owdding.burrito.Meal as SquareupBurritoMeal
        |import me.owdding.taco.Meal as SquareupTacoMeal
        |
        |public class Food {
