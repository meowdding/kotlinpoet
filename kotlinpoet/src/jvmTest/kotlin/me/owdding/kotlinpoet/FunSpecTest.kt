...
import me.owdding.kotlinpoet.FunSpec.Companion.GETTER
import me.owdding.kotlinpoet.FunSpec.Companion.SETTER
...
class FunSpecTest {
  ...
  @Test fun annotatedFunctionWithContextReceiver() {
    ...
    assertThat(funSpec.toString()).isEqualTo(
      """
      |context(kotlin.String)
      |@me.owdding.kotlinpoet.FunSpecTest.TestAnnotation
      |public fun foo() {
      |}
      |
      """.trimMargin(),
  ...
  @Test fun functionWithAnnotatedContextReceiver() {
    ...
    assertThat(funSpec.toString()).isEqualTo(
      """
      |context(@me.owdding.kotlinpoet.FunSpecTest.TestAnnotation kotlin.String)
      |public fun foo() {
      |}
      |
      """.trimMargin(),
  ...
  @Test fun functionWithAnnotatedContextParameter() {
    ...
    assertThat(funSpec.toString()).isEqualTo(
      """
      |context(user: @me.owdding.kotlinpoet.FunSpecTest.TestAnnotation kotlin.String)
      |public fun foo() {
      |}
      |
      """.trimMargin(),
