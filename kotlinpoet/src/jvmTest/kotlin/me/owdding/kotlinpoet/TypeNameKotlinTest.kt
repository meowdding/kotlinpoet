...
class TypeNameKotlinTest {
  ...
  fun typeNameOf_simple() {
    ...
    assertThat(type.toString()).isEqualTo("me.owdding.kotlinpoet.TypeNameKotlinTest")
  }
  ...
  fun typeNameOf_generic_wildcard_out() {
    ...
    assertThat(type.toString()).isEqualTo("me.owdding.kotlinpoet.TypeNameKotlinTest.GenericType<out kotlin.String>")
  }

  @Test
  fun typeNameOf_generic_wildcard_in() {
    val type = typeNameOf<GenericType<in String>>()
    assertThat(type.toString()).isEqualTo("me.owdding.kotlinpoet.TypeNameKotlinTest.GenericType<in kotlin.String>")
  }

  @Test
  fun typeNameOf_complex() {
    val type = typeNameOf<Map<String, List<Map<*, GenericType<in Set<Array<GenericType<out String>?>>>>>>>()
    assertThat(type.toString()).isEqualTo("kotlin.collections.Map<kotlin.String, kotlin.collections.List<kotlin.collections.Map<*, me.owdding.kotlinpoet.TypeNameKotlinTest.GenericType<in kotlin.collections.Set<kotlin.Array<me.owdding.kotlinpoet.TypeNameKotlinTest.GenericType<out kotlin.String>?>>>>>>")
  }
