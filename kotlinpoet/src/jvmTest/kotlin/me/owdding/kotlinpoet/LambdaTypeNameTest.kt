...
class LambdaTypeNameTest {
  ...
  @Test fun receiverWithAnnotationHasParens() {
    ...
    assertThat(typeName.toString()).isEqualTo(
      "(@me.owdding.kotlinpoet.LambdaTypeNameTest.HasSomeAnnotation kotlin.Int).() -> kotlin.Unit",
    )
  }
  ...
  @Test fun functionWithAnnotatedContextReceiver() {
    ...
    assertThat(typeName.toString()).isEqualTo(
      "context(@me.owdding.kotlinpoet.FunSpecTest.TestAnnotation kotlin.String) kotlin.Int.() -> kotlin.Unit",
    )
  }
