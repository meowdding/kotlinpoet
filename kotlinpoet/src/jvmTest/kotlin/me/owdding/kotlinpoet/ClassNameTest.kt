...
import me.owdding.kotlinpoet.Cased.Weird.Sup
...
class ClassNameTest {
  ...
  @Test fun classNameFromClass() {
    ...
    assertThat(OuterClass.InnerClass::class.java.asClassName().toString())
      .isEqualTo("me.owdding.kotlinpoet.ClassNameTest.OuterClass.InnerClass")
  }
  ...
  @Test fun classNameFromKClass() {
    ...
    assertThat(hi.packageName).isEqualTo("me.owdding.kotlinpoet.Cased.Weird")
  ...
  @Test fun spacesEscaping() {
    val tacoFactory = ClassName("me.owdding.taco factory", "Taco Factory")
    ...
    assertThat(file.toString()).isEqualTo(
      ...
      |
      |import me.owdding.`taco factory`.`Taco Factory`
      |
      |public fun main() {
